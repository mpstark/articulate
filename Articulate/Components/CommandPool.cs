...
namespace Articulate
{
    static class CommandPool
    {
        ...
        public static SrgsDocument BuildSrgsGrammar(CultureInfo cultureInfo)
        {
            ...
            Command returnToFormation = new Command("FORMUP", new string[] { "return to formation", "form up", "fallback", "fall back", "regroup", "join up", "rally on me", "rally to me" }, new ushort[] { Keys.One, Keys.One }, subjectRef);
