...
namespace SierraLib.GlobalHooks
{
    public static partial class HookManager
    {
        ...
        /// <summary>
        /// The WM_XBUTTONDOWN message is posted when the user presses the X1 or X2 mouse button
        /// </summary>
        private const int WM_XBUTTONDOWN = 0x20B;

        /// <summary>
        /// The WM_XBUTTONUP message is posted when the user releases the X1 or X2 mouse button
        /// </summary>
        private const int WM_XBUTTONUP = 0x20C;

        /// <summary>
        /// The WM_XBUTTONDBLCLK message is posted when the user double clicks the X1 or X2 mouse button
        /// </summary>
        ...
        private const short XBUTTON1 = 0x1;
        private const short XBUTTON2 = 0x2;

        private const byte MK_LBUTTON = 0x1;
        private const byte MK_RBUTTON = 0x2;
        private const byte MK_SHIFT = 0x4;
        private const byte MK_CONTROL = 0x8;
        private const byte MK_MBUTTON = 0x10;
        private const byte MK_XBUTTON1 = 0x20;
        private const byte MK_XBUTTON2 = 0x40;
