...
{
	/// <summary>
	/// Provides parsing facilities for translation files using a standard format.
	/// </summary>
	/// <remarks>
	...
	public class FileBasedTranslation : TranslationBase
	{
		...
		/// </summary>
		/// <param name="culture">The <see cref="CultureInfo"/> for which the translation is applicable</param>
		/// <param name="file">The <see cref="Stream"/> from which the translation should be parsed</param>
		...
		protected virtual void ProcessFile(Stream file)
		{
